...
public class PlayerHandler : MonoBehaviour
{
    ...
    [Header("Debug")]
    [SerializeField] private float raycastDistance = 0.7f;
    ...
    [HideInInspector] public Rigidbody m_Character;
    [HideInInspector] public CapsuleCollider m_CollisionMesh;
    ...
    private void Start()
    {
        ...
        m_CollisionMesh = GetComponent<CapsuleCollider>();
    ...
    private bool CheckGroundCollision()
    {
        ...
        {
            // Check if the object hit is tagged as ground (you can customize the tag as needed)
